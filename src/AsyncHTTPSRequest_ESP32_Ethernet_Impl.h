...
#ifndef ASYNC_HTTPS_REQUEST_ESP32_ETHERNET_IMPL_H
#define ASYNC_HTTPS_REQUEST_ESP32_ETHERNET_IMPL_H
...
{
  return String(ASYNC_HTTPS_REQUEST_ESP32_ETHERNET_VERSION);
}
...
#endif    // ASYNC_HTTPS_REQUEST_ESP32_ETHERNET_IMPL_H
